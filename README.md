...
| :question:          | [the-cows-lists-skill](https://github.com/CarstenAgerskov/skill-the-cows-lists#readme)  | This skill adds "Remember The Milk" support to Mycroft.<br>```"add milk to my grocery list"```    |
