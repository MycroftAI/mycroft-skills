...
| :heavy_check_mark:  | [skip-wake-words](https://github.com/NeonGeckoCom/skill-skip-wake-words-control.git)| Turn on/off skipping of wake words. Note: depends on skip-wake-word PR<br>```Start [stop] skipping wake words.``` 
