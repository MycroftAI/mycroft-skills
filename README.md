...
| :heavy_check_mark:  | [Desktop Control](https://github.com/TREE-Edu/desktop-control-skill/blob/master/README.md)| Mouse and keyboard control.<br>```Scroll down some, press enter key, etc.``` |
